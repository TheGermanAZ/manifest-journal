  ...
  return (
    <div className="bg-[rgba(255,255,255,0.5)] border border-[rgba(26,26,26,0.12)] p-5 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        <div>
          <p className="text-xs uppercase tracking-wide text-[var(--ink-light)] font-medium mb-1">
            Emotional Arc
          </p>
          <p className="text-sm text-[var(--ink)] leading-relaxed">{s.emotionalArc}</p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-[var(--ink)] leading-relaxed">{s.crossEntryPatterns}</p>
        </div>
        ...
        <div className="border-l-2 border-[var(--vermillion)] pl-3">
          ...
          <p className="text-sm text-[var(--ink)] leading-relaxed italic">{s.coachingMessage}</p>
        </div>
        ...
        {s.neglectedDimensions.length > 0 && (
          <div>
            ...
            <p className="text-sm text-[var(--ink)]">{s.suggestedFocus}</p>
          </div>
        )}
      </div>
    </div>
