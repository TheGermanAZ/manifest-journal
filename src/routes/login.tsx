  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="flex w-full max-w-sm flex-col items-center gap-8">
        ...
        {error && (
          <div className="w-full rounded bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700">
            {error}
          </div>
        )}
        {sent ? (
          ...
          <>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-sm">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="email" className="text-xs font-medium tracking-wide uppercase text-[var(--ink-light)]">
                  Email
                </label>
                <input
                  id="email"
                  ...
                  required
                  className="border border-[rgba(26,26,26,0.15)] bg-transparent px-3 py-2.5 text-sm text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] transition-colors"
                />
              </div>
              <button
                type="submit"
            ...
            <div className="flex items-center gap-3 w-full max-w-sm">
              ...
              <span className="text-xs text-[var(--ink-light)] tracking-wide">or</span>
              <div className="h-px flex-1 bg-[rgba(26,26,26,0.1)]" />
            </div>
            <button
              type="button"
              onClick={handleDiscord}
              className="flex w-full max-w-sm items-center justify-center gap-2 border border-[rgba(26,26,26,0.15)] bg-transparent py-2.5 text-sm font-medium tracking-wide text-[var(--ink)] hover:border-[var(--ink)] transition-colors"
            >
