      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        {step === 1 && (
          <div className="flex flex-col gap-6">
            <div>
              <h1 className="display-title text-2xl font-normal tracking-tight text-[var(--ink)]">
        ...
        {step === 2 && (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-between">
              <button
                onClick={() => setStep(1)}
                className="border border-[rgba(26,26,26,0.15)] bg-transparent px-6 py-2 text-sm font-medium text-[var(--ink)] hover:border-[var(--ink)] transition-colors"
              >
                &larr; Back
              </button>
              <button
